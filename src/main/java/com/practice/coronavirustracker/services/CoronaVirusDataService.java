package com.practice.coronavirustracker.services;
...
public class CoronaVirusDataService {
  ...
  public void fetchVirusData() throws IOException, InterruptedException {
    ...
    for (CSVRecord record : records) {
      ...
      int casesOnPrevDay = Integer.parseInt(record.get(record.size() - 2));
      stats.setLatestTotalCases(latestCases);
      stats.setDiffFromPrevDay(latestCases - casesOnPrevDay);
      newStats.add(stats);
    }
